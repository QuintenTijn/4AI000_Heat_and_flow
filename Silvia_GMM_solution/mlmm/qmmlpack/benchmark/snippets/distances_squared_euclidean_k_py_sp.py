...
description = "Squared Euclidean distance matrix K, Python/SciPy";
...
def distance_squared_euclidean(xx): return sp.squareform(sp.pdist(xx, 'sqeuclidean'))
def function(thetaval, thetaind): return distance_squared_euclidean(xx)
